...
def test_current_head_is_0010(tmp_path):
    """Feature 054: migration 0010 (upload_blobs) is the current Alembic head."""
    ...
    assert ScriptDirectory.from_config(cfg).get_current_head() == "0010"
