...
Current scope (IngestAgent / feature-003):
    - Wires Node 1 (ingest_agent) with a conditional error-short-circuit edge.
    - 'clause_splitter' route maps to END temporarily until feature-004 adds it.
...
def build_graph():
    ...
    graph.add_conditional_edges(
        ...
        {
            "end": END,
            "clause_splitter": END,  # temporary until feature-004 adds the node
        },
    )
